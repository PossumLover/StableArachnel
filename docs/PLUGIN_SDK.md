...
Upstream commit `86b028f` moved `updateMayBreakDlc` from between `detectUpdate` and
...
`CatalogEntry&` from whatever happened to be there. That is upstream issue #64 — "crash
