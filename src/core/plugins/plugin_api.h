 ...
 * the virtuals sit. Upstream moved `updateMayBreakDlc` from just after
 * `detectUpdate` to the end of the class in 86b028f without changing
 ...
 * upstream issue #64 - "crash upon updating or launching a game" - and the
